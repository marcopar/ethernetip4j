...
public class UnconnectedConnection {
    ...
    public ArrayList<EthernetIpPacket> checkAndProcessData(final ArrayList<String> tagList) {
        ...
        /*
         * manager.executeFromThreadPool(new Runnable() { public void run() {
         *
         * }
         * });
         */
    ...
    /*
     * private static void printObject(Object object){ System.out.println("Value read"); System.out.println("=========="); System.out.println("Type: "+object.getClass().toString());
