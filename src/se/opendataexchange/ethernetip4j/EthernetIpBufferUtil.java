...
/**
 * *
 * A Wrapper around a {@link ByteBuffer}. Provides methods to get/put the primitive types of the PLC system:
 *
 * USINT 1 byte (unsigned small integer) UINT 2 byte (unsigned integer) INT	2 byte (integer) REAL	4 byte (floating point value) UDINT 4 byte (unsigned double integer) DINT 4 byte (double integer) LINT
 * 8 byte (long integer)
 *
...
public class EthernetIpBufferUtil {
    ...
    public short getINT(int offset) { /*
         * 2 byte signed value
         */
