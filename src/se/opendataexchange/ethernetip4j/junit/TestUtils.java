...
public class TestUtils {
    ...
    /**
     * *
     * Randomize all values in object array. Integer (DINT, 4 bytes) Short (INT, 2 bytes, [-32767, 32767]) Boolean (0, 1) Character (SINT, 1 byte [0, 255] Float (REAL, 4 bytes [-1000, 1000]
     *
     * @param v
